    ...
    try {
        ...
        if (result.success) {
            ...
            if (result.data.suggestedActions && result.data.suggestedActions.length > 0) {
                ...
                // 隐藏建议动作
                document.getElementById('chatSuggestedActions').classList.add('hidden');
            }
        } else {
            // 显示错误
