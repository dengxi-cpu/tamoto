...
updateAIPhraseCounts();
     ...
     if (file && file.type.startsWith('image/')) {
         ...
         reader.onload = function(e) {
             ...
             img.onload = function() {
                 ...
                 console.log(`✅ 图片已压缩：${(file.size / 1024).toFixed(2)}KB → ${(compressedDataUrl.length / 1024).toFixed(2)}KB`);
             };
 ...
 function saveOCSettings() {
     ...
     // ⚠️ 移除了风格选择必须的验证（因为现在使用AI生成）
     // 用户可以选择风格，也可以不选（使用AI生成的语录）
